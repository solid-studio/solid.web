...
export const createConnectionEpic = (action$: ActionsObservable<CreateConnectionAction>, state$: StateObservable<ApplicationState>, ajax: AjaxCreationMethod) => action$.pipe(
...
export const onCreateConnectionCompletedEpic = (action$: ActionsObservable<CreateConnectionAction>) => action$.pipe(
...
export const getConnectionsEpic = (action$: ActionsObservable<GetConnectionsAction>, state$: StateObservable<ApplicationState>, ajax: AjaxCreationMethod) => action$.pipe(
...
export const onConnectionItemSelectedEpic = (action$: ActionsObservable<ConnectionItemSelectedAction>) => action$.pipe(
