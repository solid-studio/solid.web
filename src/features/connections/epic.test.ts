...
import { getConnections, connectionsReceived, connectionCreated, closeConnectionModal, connectionItemSelected, createOrUpdateConnection } from './actions';
import { getConnectionsEpic, onCreateConnectionCompletedEpic, onConnectionItemSelectedEpic, createConnectionEpic } from './epic';
