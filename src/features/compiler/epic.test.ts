...
import { LoadCompilerVersionAction, LoadCompilerVersionResultAction, SetupMessageDispatcherAction } from './action-types';
import { loadCompilerVersion, compilerVersionLoaded, loadCompilerVersionFailed, setupMessageDispatcher } from './actions';
