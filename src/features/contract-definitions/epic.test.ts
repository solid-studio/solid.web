...
import { buildFakeContractDefinitions, buildFakeContractDefinition } from '@solid-explorer/types'
...
describe('Contract Definitions Epic Tests', () => {
  ...
  test('onContractDefinitionSelectedEpic', done => {
    ...
    const contractDefinitionSelectedAction: ContractDefinitionSelectedAction = contractDefinitionSelected(
