...
export const getContractsEpic = (
  action$: ActionsObservable<GetContractsAction>,
...
export const contractsEpic = combineEpics(getContractsEpic, onMaximizeContractEpic)
