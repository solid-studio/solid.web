...
export type MyWorkerMessage = ILoadCompilerVersionMessage | ILoadCompilerVersionResultMessage
    | IValidateSourceCodeMessage | IValidateSourceCodeResultMessage
    | ICompileMessage | ICompileResultMessage
    | IErrorMessage;
